...
export async function activateFlowrExtension(context: vscode.ExtensionContext) {
...
let webMode = vscode.env.uiKind === vscode.UIKind.Web;

export function setWebMode(web: boolean) {
	webMode = web;
}
...
export let VSCodeFlowrConfiguration: FlowrConfigOptions = defaultConfigOptions;

export function updateFlowrConfig() {
